...
namespace Ajax.Controllers
{
    public class ApiController : Controller
    {
        ...
        public IActionResult Spots([FromBody] SearchDTO _search) //因為要接收JSON格式的資料 ,所以用[FromBody]來接收
        {
            ...
            {
                spots = spots.Where(x => x.SpotTitle.Contains(_search.Keyword) || x.SpotDescription.Contains(_search.Keyword));
            }
            ...
            int TotalPages = (int)Math.Ceiling((double)TotalCount / pageSize); //計算出總共有幾頁
